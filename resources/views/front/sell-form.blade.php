...
<form  method="POST" action="{{route('guest.store')}}" class="form-control" >
    @csrf
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group"> <label for="form_email">Usdt Amount To Sell * </label> <input id="form_email" type="number" min="50" name="amount" class="form-control"  required="required" > </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 " style="padding: 5px;"> <input type="submit" class="btn btn-danger btn-send pt-2 btn-block " value="Sell Usdt"> </div>
                                </div>
                            </div>
                        </form>